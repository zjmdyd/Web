...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, { emit }) {
    ...
    vue.watch([triggeringElementRef, vue.toRef(props, "trigger")], ([triggeringElement, trigger], [prevTriggeringElement]) => {
      var _a, _b, _c;
      const triggerArray = shared.isArray(trigger) ? trigger : [trigger];
