...
_typeof("Bill"); // 返回 "string"


_typeof(3.14); // 返回 "number"


typeof NaN === "undefined" ? "undefined" : _typeof(NaN); // 返回 "number"

_typeof(false); // 返回 "boolean"


_typeof([1, 2, 3, 4]); // 返回 "object"
...
_typeof(new Date()); // 返回 "object"


_typeof(function () {}); // 返回 "function"


typeof myCar === "undefined" ? "undefined" : _typeof(myCar); // 返回 "undefined" *

_typeof(null); // 返回 "object"
...
function isArray(myArray) {
  var mConstructor = myArray.constructor.toString();
  var idx = mConstructor.indexOf("Array"); // idx = 9
...
function isArray2(myArray) {
  var mConstructor = myArray.constructor;
  console.log("mConstructor = " + mConstructor);
...
function isDate(mDate) {
  var mConstructor = mDate.constructor;
  console.log("mConstructor = " + mConstructor);
...
console.log("typeof(person) = " + _typeof(person)); // typeof(person) = object
...
console.log("typeof undefined = " + (typeof undefined === "undefined" ? "undefined" : _typeof(undefined))); // undefined

console.log("typeof null = " + _typeof(null)); // object
