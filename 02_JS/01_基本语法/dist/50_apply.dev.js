...
var m1 = Math.max.apply(null, [1, 2, 3]); // 也会返回 3

console.log(m1); // 第一个参数（null）无关紧要。在本例中未使用它。

var m2 = Math.max.apply(Math, [1, 2, 3]); // 也会返回 3

console.log(m2);
var m3 = Math.max.apply(" ", [1, 2, 3]); // 也会返回 3
