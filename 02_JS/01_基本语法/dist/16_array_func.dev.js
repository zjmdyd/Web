...
fruits.splice(2, 0, "Lemon", "Kiwi"); // after_splice_fruits = anana,Orange,Lemon,Kiwi,Apple,Mango

console.log("after_splice_fruits = " + fruits);
var fruits = ["Banana", "Orange", "Apple", "Mango", "Mango2"];
var splice_back_value = fruits.splice(2, 2, "Lemon", "Kiwi"); // splice_back_value = Apple,Mango

console.log('splice_back_value = ' + splice_back_value); // after_splice_fruits = Banana,Orange,Lemon,Kiwi,Mango2
...
var ary2 = ["b"];
var ary3 = ["c"];
var ary4 = ary1.concat(ary2, ary3); // ary4 = a,b,c
...
var ary3 = ary1.slice(2); // ary2 = b,c,d

console.log("ary2 = " + ary2); // ary3 = c,d
...
var ary4 = ary1.slice(1, 3); // ary4 = b,c
