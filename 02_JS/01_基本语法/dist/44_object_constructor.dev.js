...
var pb = new Person("Steve", "Jobs", 56, "green"); // 与向已有对象添加新属性不同，您无法为对象构造器添加新属性：

Person.nationality = "English";
console.log(Person); // 为已有的对象添加新属性很简单：
...
console.log(pa); // Person { firstName: 'Steve', lastName: 'Jobs', age: 56, eye: 'green' }
